class ObjetivoSemanal < ApplicationRecord
	...
	validates_uniqueness_of :numero_semana, scope: [:punto_venta_id, :vendedor_id, :tipo_objetivo_id, :mes, :anio] ,  :message=>"Ya posee un tipo de objetivo para ese pv para esa semana %{value}" , on: :create
