...
class TipoDocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_documento" do
    assert_difference('TipoDocumento.count') do
      post tipo_documentos_url, params: { tipo_documento: { descripcion: @tipo_documento.descripcion } }
    end
  ...
  test "should update tipo_documento" do
    patch tipo_documento_url(@tipo_documento), params: { tipo_documento: { descripcion: @tipo_documento.descripcion } }
